...
const BrandMovieCard = ({ movies }) => {
  const { name, brand, type, price, rating, details, image } = movies;
  //   console.log(movies);
  ...
  return (
    <div className="border ">
      <div className="w-[300px] md:w-[360px] lg:w-96  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
